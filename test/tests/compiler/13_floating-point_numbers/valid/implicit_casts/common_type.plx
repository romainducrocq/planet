...
pub fn lt(d: f64, l: i64) i32 {
    #  l is implicitly converted to a double
    return d < l
}

pub fn tern_double_flag(flag: f64) f64 {
    ...
    #      
    return cast<f64>((? flag then -30 else 10ul))
}

pub fn tern_double_result(flag: i32) f64 {
    ...
    #      
    return ? flag then 5.0 else 9223372036854777850ul
}
pub ten: i32 = 10
pub fn multiply(none) i32 {
...
pub fn main(none) bool {
    ...
    #      
    if lt(-
        9007199254751228.0, -9007199254751227l
        ) {
        return 1
    }
