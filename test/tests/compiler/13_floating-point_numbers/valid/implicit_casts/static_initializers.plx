...
pub d1: f64 = 2147483647
pub d2: f64 = 4294967295u
...
#  
pub d3: f64 = 4611686018427389440l

#  We'll round this down to 4611686018427389952.0 
pub d4: f64 = 4611686018427389955l

#  Using round-to-nearest, this rounds to 9223372036854775808 
pub d5: f64 = 9223372036854775810ul
pub d6: f64 = 4611686018427389955ul #  this as the same value as d4 and should round to the same double
...
#  
pub d7: f64 = 9223372036854776832ul

pub uninitialized: f64; #  should be initialized to 0.0

#  integer variables

i: i32 = 4.9 #  truncated to 4

pub u: u32 = 42949.672923e5 #  truncated to 4294967292u

#  this token is first converted to a double w/ value 4611686018427389952.0,
#  then truncated down to long 4611686018427389952
pub l: i64 = 4611686018427389440.

pub ul: u64 = 18446744073709549568.
