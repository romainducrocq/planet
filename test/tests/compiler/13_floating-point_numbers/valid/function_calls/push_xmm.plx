...
pub fn callee(a: f64, b: f64, c: f64, d: f64, e: f64, f: f64, g: f64, h: f64, i: f64, j: f64, k: f64) i32 {
    if a ~= 0. {         return 1
    }
    if b ~= 1. {
        return 2
...
pub fn target(a: bool, b: i32, c: i32, d: i32, e: i32) i32 {
    return callee(0., 1., 2., 3., 4., 5., e + 1., d + 3., c + 5., b + 7.,         a + 9.)
}

pub fn main(none) i32 {
    return target(true, 2, 3, 4, 5)
}
