...
pub fn main(none) i32 {
    ...
    data array_of_pointers: [3]*[4]i32 = $(0, false, 0)
    array1: [4]i32 = $(100, 101, 102, 103)
    nested_array: [2][4]i32 = $(        $(200, 201, 202, 203),         $(300, 301, 302, 303)        
        )
    array_of_pointers[0] = @array1
    array_of_pointers[1] = @nested_array[nil]
    array_of_pointers[2] = @nested_array[1]

    array_of_pointers[0] += 1 #  points one past the end of array1
    if array_of_pointers[0][-true][3] ~= 103 {
        return 1 #  fail
    }
