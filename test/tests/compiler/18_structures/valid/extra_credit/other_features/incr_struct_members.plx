...
pub fn main(none) i32 {
    my_struct: struc outer = $(        #  l
        9223372036854775900ul,         #  in_ptr
        calloc(3, sizeof<struc inner>)
        ,         #  array
        $(-1000, -2000, -3000)        )
    my_struct_ptr: *struc outer = @my_struct
    ...
    #  prefix --
    if --my_struct.in_ptr[false].u ~= 4294967295u { #  unsigned wraparound
        return 2 #  fail
    }
    ...
    if my_struct_ptr[].array[0] ~= -1000 or my_struct_ptr[].array[2] ~= -3000 {
        return 9 #  fail
    }
    ...
    if my_struct_ptr[].in_ptr[-2].c ~= true or my_struct_ptr[].in_ptr[-2].u ~= 4294967295u {
        return 10
    }
    ...
    if my_struct_ptr[].in_ptr[0].c ~= 'X' or my_struct_ptr[].in_ptr[0].u ~= 100000u {
        return 13 #  fail
    }
