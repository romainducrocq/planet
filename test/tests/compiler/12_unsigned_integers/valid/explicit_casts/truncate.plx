...
pub fn ulong_to_int(ul: u64, expected: i32) i32 {
    result: i32 = cast<i32>(ul)
    return (result == expected)
}

pub fn ulong_to_uint(ul: u64, expected: u32) i32 {
    return (cast<u32>(ul) == expected)
}

pub fn long_to_uint(l: i64, expected: u32
    ) i32 {
    return cast<u32>(l
        ) == expected
}
...
pub fn main(none) i32 {
    ...
    if not long_to_uint(-9223372036854774574l, 1234u) {
        return 2
    }
    ...
    if not ulong_to_int(100ul, 100) {
        return 3
    }

    if not ulong_to_uint(100ul, 100u) {
        return 4
    }
    ...
    #      
    if not ulong_to_uint(4294967200ul, 4294967200u) {
        return 5
    }

    if not ulong_to_int(4294967200ul, -96) {
        return 6
    }
    ...
    if not ulong_to_uint(1152921506754330624ul, 2147483648u) { #  reduce to 2^31
        return 7
    }

    if not ulong_to_int(1152921506754330624ul, -2147483648) { #  reduce to -2^31
        return 8
    }
    ...
    #      
    ui: u32 = cast<u32>(17179869189ul) #  2^34 + 5
    if ui ~= 5 {
        return 9
    }
